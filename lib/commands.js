...
function toggleBold() {
    return editorHelpers.surroundSelection('**', '**', /\*{2}\w*\*{2}|\w+/);
}

function toggleItalic() {
    return editorHelpers.surroundSelection('_', '_', /_?\w*_?/);
}
...
function toggleCodeBlock() {
    return editorHelpers.surroundBlockSelection(startingBlock, '```')
}

function toggleInlineCode() {
    return editorHelpers.surroundSelection('`', '`', /`\w*`|\w+/);
}
